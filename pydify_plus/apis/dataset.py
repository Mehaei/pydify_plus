...
class DatasetApi(BaseApi):
    ...
    async def create_dataset(
        ...
        return await self.request(
            "POST", API_ENDPOINTS["DATASETS_CREATE"], json=payload
        )
    ...
    async def get_dataset(self, *, dataset_id: str) -> dict:
        ...
        """
        return await self.request(
            "GET", API_ENDPOINTS["DATASET_DETAIL"].format(dataset_id=dataset_id)
        )
    ...
    async def update_dataset(
        ...
        *,
        ...
        return await self.request(
            "PATCH",
            API_ENDPOINTS["DATASET_UPDATE"].format(dataset_id=dataset_id),
            json=payload,
        )
    ...
    async def delete_dataset(self, *, dataset_id: str) -> dict:
        ...
        """
        return await self.request(
            "DELETE", API_ENDPOINTS["DATASET_DELETE"].format(dataset_id=dataset_id)
        )
